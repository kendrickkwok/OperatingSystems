...
//This program performs synchronization with a mutex lock
...
int main(int argc, char **argv)
{
	...
	if (pthread_mutex_init(&lock, NULL) !=0)	
		printf("mutex initialization does not work!\n");
	//****************************************************
	...
	//destroys the mutex lock after all threads have finished executing 
